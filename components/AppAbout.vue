...
<template>
  <div>
    <button class="menu-link" @click="openModal">Что умеет KKLuck?</button>

    <AppModal
      :is-open="isModalOpen"
      title="Что умеет KKLuck?"
      @close="closeModal"
    >
      <div class="about-content">
        ...
        <div class="feature">
          ...
          <ul class="feature-list">
            ...
            <li>Укажите количество победителей (от 1 до 100)</li>
            <li>
              Получите случайно выбранных победителей из тех, кто оставил
              комментарий
            </li>
          </ul>
        </div>
        ...
        <ol class="usage-list">
          ...
          <li>
            <span class="usage-step"
              >Если выбран отбор по комментариям, вы можете дополнительно
              фильтровать по содержанию:</span
            >
            <ul class="usage-sublist">
        ...
        <ul class="tech-list">
          ...
          <li>
            Максимальное количество победителей ограничено количеством
