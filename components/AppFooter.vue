<template>
  <footer
    class="footer border-t-5 border-(--color-primary) flex items-center justify-between pl-5 pr-5 h-20 md:h-25 bg-(--background-toolbar)"
  >
    <div class="max-w-7xl w-full m-auto flex justify-between">
      <div class="flex items-center">
        <a href="https://kknights.com/" target="_blank">
          <svg
            class="fill-(--color-primary) h-7.5"
      ...
      <div class="flex items-center text-(--text-title)">
        <a
          class="cursor-pointer inline-flex justify-center rounded-md border mr-4 border-transparent bg-(--button-donation) px-2 py-1 text-sm font-medium text-(--background-toolbar) opacity-80 hover:opacity-100 hover:text-(--text-reverted) focus:outline-none focus-visible:ring-2 focus-visible:ring-(color-primary) focus-visible:ring-offset-2"
          href="https://yoomoney.ru/to/41001420208384"
          target="_blank"
          >На кофе :3</a
        >
        <a href="https://github.com/konstantinstukov/kkluck" target="_blank">
          dev by KS
        </a>
      </div>
    </div>
