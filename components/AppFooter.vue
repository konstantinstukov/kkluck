...
<template>
  <footer
    class="footer light flex items-center justify-between pl-5 pr-5 h-20 md:h-25"
  >
    <div class="max-w-7xl w-full m-auto flex justify-between">
      <div class="flex items-center">
        <a target="_blank" href="https://kknights.com/">
          <svg
            class="fill-(--color-blue-900) h-7.5"
      ...
      <div class="flex flex-col items-center text-(--color-blue-900)">
        <a target="_blank" href="https://github.com/konstantinstukov/kkluck">
          dev by KS
        </a>
        <a
